  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="姓名" prop="xingming">
              <el-input v-model="ruleForm.xingming" 
                placeholder="姓名" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="兑换编号" prop="duihuanbianhao">
          <el-select  @change="duihuanbianhaoChange" v-model="ruleForm.duihuanbianhao" placeholder="请选择兑换编号">
            <el-option
                v-for="(item,index) in duihuanbianhaoOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.duihuanbianhao" label="兑换编号" prop="duihuanbianhao">
              <el-input v-model="ruleForm.duihuanbianhao" 
                placeholder="兑换编号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="商品名称" prop="shangpinmingcheng">
              <el-input v-model="ruleForm.shangpinmingcheng" 
                placeholder="商品名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="积分数" prop="jifenshu">
          <el-input v-model="ruleForm.jifenshu" 
              placeholder="积分数" clearable  :readonly="ro.jifenshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="积分数" prop="jifenshu">
              <el-input v-model="ruleForm.jifenshu" 
                placeholder="积分数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shangpinmingcheng = true;
            continue;
	            	            ...
	            	            if(o=='jifenshu'){
            this.ruleForm.jifenshu = obj[o];
	    this.ro.jifenshu = true;
            continue;
          }
	                    }
                                                                                        this.ruleForm.jifenshu = 0
	this.ro.jifenshu = false;
                      }
            // 获取用户信息
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                              ...
                                                                              this.$http({
              url: `option/lipinduihuan/duihuanbianhao`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.duihuanbianhaoOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
                            ...
                            // 下二随
    duihuanbianhaoChange () {
      this.$http({
        url: `follow/lipinduihuan/duihuanbianhao?columnValue=`+ this.ruleForm.duihuanbianhao,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
                ...
                this.ruleForm.shangpinmingcheng = data.data.shangpinmingcheng
                                                ...
                                                if(data.data.jifenshu){
                this.ruleForm.jifenshu = data.data.jifenshu
              }
                              } else {
          this.$message.error(data.msg);
        }
    ...
    onSubmit() {
      ...
      obj.jifenshu = obj.jifenshu - this.ruleForm.jifenshu
      if(obj.jifenshu<0){
        this.$message.error("积分数不足");
        return
      }
      this.$http({
          url: `${table}/update`,
        ...
        if (valid) {
          this.$http({
            url: `jifenxiaohao/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jifenxiaohaoCrossAddOrUpdateFlag = false;
                  this.parent.search();
