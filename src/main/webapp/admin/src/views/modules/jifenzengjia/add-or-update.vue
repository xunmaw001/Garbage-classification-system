  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jilushijian" label="记录时间" prop="jilushijian">
              <el-input v-model="ruleForm.jilushijian" 
                placeholder="记录时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
      ...
      obj.jifenshu = parseFloat(obj.jifenshu) + parseFloat(this.ruleForm.jifenshu)
      this.$http({
          url: `${table}/update`,
          method: "post",
          data: obj
