<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="兑换编号" prop="duihuanbianhao">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.duihuanshijian" label="兑换时间" prop="duihuanshijian">
              <el-input v-model="ruleForm.duihuanshijian" 
                placeholder="兑换时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                                          </el-row>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `lipinduihuan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.lipinduihuanCrossAddOrUpdateFlag = false;
                  this.parent.search();
